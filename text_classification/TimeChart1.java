...
public class TimeChart1 extends ApplicationFrame{
	static long normal,parallel;
	static String title;
public TimeChart1(String paramString,long n,long p){
	super(paramString);
	normal = n;
	parallel = p; 
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(parallel,"Parallel Processing Time","Parallel Processing Time");
	localDefaultCategoryDataset.addValue(normal,"Normal Processing Time","Normal Processing Time");
