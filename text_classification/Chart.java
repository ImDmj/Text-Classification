...
public class Chart extends ApplicationFrame{
	static int test,classify;
	static String title;
public Chart(String paramString,int t,int c){
	super(paramString);
	test = t;
	classify = c; 
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(test,"Test Dataset Size","Test Dataset Size");
	localDefaultCategoryDataset.addValue(classify,"Classified Document Size","Classified Document Size");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Test Document Size", "Classification Size", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
