...
public class TimeChart extends ApplicationFrame{
	static String title;
public TimeChart(String paramString){
	super(paramString);
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(KNN.precision,"Smtp Precision","Smtp Precision");
	localDefaultCategoryDataset.addValue(KNN.precision1,"Ed Precision","Ed Precision");
	localDefaultCategoryDataset.addValue(KNN.recall,"Smtp Recall","Smtp Recall");
	localDefaultCategoryDataset.addValue(KNN.recall1,"Ed Recall","Ed Recall");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Technique Name", "Processing Time (M.S)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
